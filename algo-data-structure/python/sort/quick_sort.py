...
def _partition(arr: List[int], start: int, end: int) -> int:
    ...
    1. choose a random item in the array as the pivot.
    2. split the array, all the items in arr[start: pivot_idx] < pivot, and  all the items in arr[pivot_idx + 1: end] > pivot
    """
